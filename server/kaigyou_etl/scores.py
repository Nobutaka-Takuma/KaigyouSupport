        ...
        for model in models:
            ...
            for start in range(0, len(batch), 500):
                ...
                INSERT INTO mesh_scores (
                    ...
                    %(population_growth)s, %(population_change_projected)s,
                    %(facility_count)s,
                ...
                DO UPDATE SET
                    ...
                    population_change_projected = EXCLUDED.population_change_projected,
                    computed_at = now()
...
def _score_row(model: ScoringModel, row: Mapping[str, Any],
    ...
    return {
        ...
        "population_change_projected": row.get("population_change_projected"),
